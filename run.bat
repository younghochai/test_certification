...
python calc_human.py --bg_pcd_path ./data/test0.pcd --human_pcd_path ./data/test2.pcd --out_pcd_path ./data/result/test_result2.pcd
...
python patch_bvh.py ./data/BVH/input.bvh --pelvis_csv ./data/result/position_vector.csv --Hips --Chest --RightCollar --RightShoulder --RightElbow --RightWrist
